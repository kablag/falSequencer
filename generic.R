...
addNuc <- function(samplePoints,
  ...
  switch(nuc,
    ...
    "R" = { addRealNuc("A", pheight/2); addRealNuc("G", pheight/2)},
    "Y" = { addRealNuc("C", pheight/2); addRealNuc("T", pheight/2)},
    "S" = { addRealNuc("G", pheight/2); addRealNuc("C", pheight/2)},
    "W" = { addRealNuc("A", pheight/2); addRealNuc("T", pheight/2)},
    "K" = { addRealNuc("G", pheight/2); addRealNuc("T", pheight/2)},
    "M" = { addRealNuc("A", pheight/2); addRealNuc("C", pheight/2)},
    "B" = { addRealNuc("C", pheight/3); addRealNuc("G", pheight/3); addRealNuc("T", pheight/3);},
    "D" = { addRealNuc("A", pheight/3); addRealNuc("G", pheight/3); addRealNuc("T", pheight/3);},
    "H" = { addRealNuc("A", pheight/3); addRealNuc("C", pheight/3); addRealNuc("T", pheight/3);},
    "V" = { addRealNuc("A", pheight/3); addRealNuc("C", pheight/3); addRealNuc("G", pheight/3);},
    "N" = { addRealNuc("A", pheight/4); addRealNuc("C", pheight/4); addRealNuc("G", pheight/4); addRealNuc("T", pheight/4);},
    "_"
  )
  samplePoints
}
